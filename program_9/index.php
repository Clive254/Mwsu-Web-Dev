...
<head>
	...
	<link rel="stylesheet" type="text/css" media="screen" href="http://maxcdn.bootstrapcdn.com/bootstrap/3.3.6/css/bootstrap.min.css" />
    ...
    */
    ...
    function loadTableData(page, page_size,sort,order) {
		...
		$('#search-btn').click(function(event){
			...
			searchkey = $('#search-keys').val();
			page = 1;
			page_size = 10;
			
			paginatedata(1,10);
			function paginatedata(page, page_size){
				console.log(page);
				$('#pagination-demo').twbsPagination('destroy');
				$.get("http://107.170.39.161/api/api.php/products?filter=desc,cs," + searchkey + "&order=id" + "&page=" + page + "," + page_size)
				...
				.done(function(data) {
					...
					$('#pagination-demo').twbsPagination({
						...
						onPageClick: function (event, page) {
							...
							//tablegen(data);
							$.get("http://107.170.39.161/api/api.php/products?filter=desc,cs," + searchkey + "&order=id" + "&page=" + page + "," + 10)
    ...
    function getTotalPages(){
        $.get("http://107.170.39.161/program_9/total_pages.txt")
	...
	function addCartItem(item){
		...
		$.post("http://107.170.39.161/api/api.php/shopping_cart/",postData);
	}
