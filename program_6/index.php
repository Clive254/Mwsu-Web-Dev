...
<div class="modal hide" id="pleaseWaitDialog" data-backdrop="static" data-keyboard="false">
	...
	<div class="modal in " id="confirm-delete" role="dialog" aria-labelledby="basicModal" aria-hidden="true">>
      ...
      <div class="modal-body">
        ...
        <div class="row">
            <div class="col-12-xs text-center">
                <button class="btn btn-success btn-md" id="delete-item">Yes</button>
                <button class="btn btn-danger btn-md" id="cancel-delete">No</button>
            </div>
        </div>
      </div>
    ...
    function loadTableData(page, page_size,sort,order) {
        ...
        .done(function(data) {
            ...
            for (var i = 0; i < cols.length; i++) {
                ...
                col_head += "<th class="+"sort"+"><button>" + cols[i];
            ...
            for (var i = 0; i < records.length; i++) {
                ...
                rows = rows + '<td style="vertical-align:middle" nowrap><i class="fa fa-pencil-square-o" aria-hidden="true"></i> <i class="fa fa-trash-o btnDelete" aria-hidden="true" id="btnDelete" data-toggle="modal" data-target="#confirm-delete" ></i></td>';              
           ...
           /*  $('.sort-up').click(function(){
            ...
            $('button').click(function(){
				...
				var column = $this.parent().text();
				console.log($this.parent().text());
				$('.sort').toggle(loadTableData(page,10,column),loadTableData(page,10,column,"desc"));
			});
           
		     $('.btnDelete').click(function(){
				var $row = $(this).closest("tr");
                $t_data1 = $row.find("td:nth-child(1)").text(); 
                $t_data = $row.find("td:nth-child(3)").text();  		
				$('#prod_Desc').text($t_data);				
				$('#Id').val($t_data1);				
				$.modal('show');
			});
             ...
             $('#delete-item').click(function(){
                ...
                $.ajax({
				url: ('http://107.170.39.161/api/api.php/products/'+$id),
				type: 'DELETE',				
				traditional:true,
				dataType: 'json',
